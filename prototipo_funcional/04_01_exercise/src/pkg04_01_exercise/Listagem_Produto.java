 ...
 * @author aluno
 */
public class Listagem_Produto extends javax.swing.JFrame {

    /**
     * Creates new form Listagem_Produto
     */
    public Listagem_Produto() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listagem_Produto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Listagem_Produto().setVisible(true);
            }
        });
    }
